...
public class BookstageDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        user.Property(u => u.DateOfBirth).HasColumnType("date");
        ...
        movie.Property(m => m.ReleaseDate).HasColumnType("timestamp with time zone");
        movie.Property(m => m.CreatedAt).HasColumnType("timestamp with time zone");
        movie.Property(m => m.UpdatedAt).HasColumnType("timestamp with time zone");
        ...
        evt.Property(e => e.EventDate).HasColumnType("timestamp with time zone");
        evt.Property(e => e.EventTime).HasColumnType("time");
        evt.Property(e => e.CreatedAt).HasColumnType("timestamp with time zone");
        evt.Property(e => e.UpdatedAt).HasColumnType("timestamp with time zone");
        ...
        showTime.Property(s => s.ShowDate).HasColumnType("timestamp with time zone");
        showTime.Property(s => s.ShowTimeOfDay).HasColumnType("time");
        showTime.Property(s => s.CreatedAt).HasColumnType("timestamp with time zone");
        showTime.Property(s => s.UpdatedAt).HasColumnType("timestamp with time zone");
        ...
        seat.Property(s => s.CreatedAt).HasColumnType("timestamp with time zone");
        seat.Property(s => s.UpdatedAt).HasColumnType("timestamp with time zone");
        ...
        booking.Property(b => b.BookingDate).HasColumnType("timestamp with time zone");
        booking.Property(b => b.EventDate).HasColumnType("timestamp with time zone");
        booking.Property(b => b.EventTime).HasColumnType("time");
        booking.Property(b => b.CreatedAt).HasColumnType("timestamp with time zone");
        booking.Property(b => b.UpdatedAt).HasColumnType("timestamp with time zone");
        ...
        review.Property(r => r.CreatedAt).HasColumnType("timestamp with time zone");
        ...
        seatLock.Property(sl => sl.LockedAt).HasColumnType("timestamp with time zone");
        seatLock.Property(sl => sl.ExpiresAt).HasColumnType("timestamp with time zone");
        ...
        payment.Property(p => p.UpdatedAt).HasColumnType("timestamp with time zone");
        ...
        offer.Property(o => o.ValidFrom).HasColumnType("timestamp with time zone");
        offer.Property(o => o.ValidTo).HasColumnType("timestamp with time zone");
        offer.Property(o => o.CreatedAt).HasColumnType("timestamp with time zone");
        offer.Property(o => o.UpdatedAt).HasColumnType("timestamp with time zone");
    }
}