    ...
    public static async Task SeedDataAsync(BookstageDbContext context, IPasswordHasher<object> passwordHasher)
    {
        ...
        var movies = new List<Movie>
        {
            ...
            new Movie
            {
                ...
                Rating = 7.4,
                Duration = 169,
                ReleaseDate = UtcDate(2024, 10, 10),
                          ...
                          TimeSpan time, double price, int total, int available)
        {
            showTimes.Add(new ShowTime
            {
                ...
                VenueName = venue,
                VenueCity = city,
                ShowDate = DateTime.UtcNow.Date.AddDays(daysAhead),
                ShowTimeOfDay = time,
                Price = price,
                TotalSeats = total,
        ...
        var events = new List<Event>
        {
            ...
            new Event
            {
                ...
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(10),
            ...
            new Event
            {
                ...
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(21),
                EventTime = new TimeSpan(19, 00, 0),
                Price = 4999,
                Rating = 9.7,
                BannerUrl = "",
            ...
            new Event
            {
                ...
                VenueCity = "Chennai",
                EventDate = DateTime.UtcNow.Date.AddDays(18),
            ...
            new Event
            {
                ...
                VenueCity = "Ahmedabad",
                EventDate = DateTime.UtcNow.Date.AddDays(15),
                EventTime = new TimeSpan(18, 30, 0),
                Price = 3500,
                Rating = 9.4,
                BannerUrl = "",
            ...
            new Event
            {
                ...
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(12),
            ...
            new Event
            {
                ...
                VenueName = "Wankhede Stadium",
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(8),
                EventTime = new TimeSpan(19, 30, 0),
                Price = 4500,
                Rating = 9.6,
                BannerUrl = "",
            ...
            new Event
            {
                ...
                VenueCity = "Bangalore",
                EventDate = DateTime.UtcNow.Date.AddDays(11),
                EventTime = new TimeSpan(19, 30, 0),
                Price = 3000,
                Rating = 9.2,
                BannerUrl = "",
            ...
            new Event
            {
                ...
                VenueCity = "Ahmedabad",
                EventDate = DateTime.UtcNow.Date.AddDays(25),
            ...
            new Event
            {
                ...
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(9),
            ...
            new Event
            {
                ...
                VenueName = "NSCI Dome",
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(22),
                EventTime = new TimeSpan(19, 30, 0),
                Price = 1800,
                Rating = 8.6,
                BannerUrl = "",
            ...
            new Event
            {
                ...
                VenueCity = "Delhi",
                EventDate = DateTime.UtcNow.Date.AddDays(16),
                EventTime = new TimeSpan(19, 00, 0),
                Price = 2200,
                Rating = 9.0,
                BannerUrl = "",
            ...
            new Event
            {
                ...
                VenueCity = "Mumbai",
                EventDate = DateTime.UtcNow.Date.AddDays(35),
        ...
        var offers = new List<Offer>
        {
            ...
            new Offer
            {
                ...
                ApplicableFor = "event",
                ValidFrom = DateTime.UtcNow,
                ValidTo = DateTime.UtcNow.AddDays(45),
                CreatedAt = DateTime.UtcNow,
                UpdatedAt = DateTime.UtcNow
            }
        };
