                            ...
                            >
                                <Link to={`/events/${event.id}`} className="event-card block" id={`event-card-${event.id}`}>
                                    <div className="relative aspect-video overflow-hidden">
                                        <img src={event.bannerUrl || 'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=400&q=80'} alt={event.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
